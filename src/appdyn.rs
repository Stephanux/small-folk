...
et la gestion des routes actuellement en dur dans le code source. Trouver une solution pour
les extraire dans un fichier de configuration */
pub mod appdyn {
    ...
    pub async fn main() {
        ...
        // Démarrage du serveur en asynchrone sur le port 8080
